...
alumnos.reverse()
print(alumnos)
sorted_alumnos = sorted(alumnos) #orden alfabetico ordenado (primero se ponen los numeros y luego las letras)
print(alumnos)
